...
namespace KafkaSnapshot.Export.Tests
{
    public class OriginalKeySerializerTests
    {
        ...
        public void OriginalKeySerializerCanSerializeData()
        {
            ...
            var data = new[]
            {
                new KeyValuePair<object, MetaMessage<string>>(1,new MetaMessage<string>("{\"Test\":42}",new MessageMeta(dateTime,1)))
            };
            string result = null!;
        ...
        public void OriginalKeySerializerCantSerializeNonData()
        {
            ...
            var data = new[]
            {
                new KeyValuePair<object, MetaMessage<string>>(1,new MetaMessage<string>("Test",new MessageMeta(dateTime,1)))
            };
            string result = null!;
